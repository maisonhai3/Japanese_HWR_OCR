...
if __name__ == '__main__':
    ...
    parser.add_argument('--chars_file', type=str, default='E:/POCR/src_code/text_renderer-master/text_renderer-master/data/chars/jpn.txt')
    parser.add_argument('--font_dir', type=str, default='E:/POCR/src_code/text_renderer-master/text_renderer-master/data/fonts/jpn')
